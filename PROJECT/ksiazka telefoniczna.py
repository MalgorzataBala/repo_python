...
class User:
    def __init__(self, phonenr, first_name, last_name):
...
juserzy = UserList({
    '123456789': User('123456789', 'Jan', 'Kowalski'),
    '234567890': User('23456789', 'Marek', 'Nowak'),
    '345678901': User('345678901', 'Anna', 'Kowal')
})

zaczynamy = PhoneBook(juserzy)
zaczynamy.menu()
